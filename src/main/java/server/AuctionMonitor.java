...
/**
 * Η κλάση AuctionMonitor τρέχει σε ξεχωριστό daemon thread και ελέγχει περιοδικά
 * (κάθε 1 δευτερόλεπτο) αν η τρέχουσα δημοπρασία έχει λήξει.
 * Αν έχει λήξει, καλεί τον ServerState για να την οριστικοποιήσει και να ξεκινήσει την επόμενη δημοπρασία από την ουρά.
 *
 */
